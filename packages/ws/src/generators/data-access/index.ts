...
export default async function dataAccessGenerator(
  ...
  if (dataAccessProject) {
    console.log(
      `${dataAccessProject.name} exists for domain ${domain.fileName}.`
    );
    return;
  }
